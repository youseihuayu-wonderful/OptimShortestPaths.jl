"""
Curated kinase inhibitor dataset from ChEMBL and FDA sources.
...
Data sources:
  - IC50 values: ChEMBL 36 (literature-reported, primary assay data)
  - Toxicity: FDA labels, LiverTox database
  - Targets: UniProt/ChEMBL target annotations
  - Indications: FDA-approved labels (DailyMed)
...
CURATED_DATA = {
    "compounds": [
        ...
        # --- Edge cases for SMILES validation testing ---
    ...
    # IC50 values (nM) — literature-reported values from ChEMBL 36
    "bioactivities": [
        ...
        # Sorafenib: multi-kinase (VEGFR2 + BRAF)
